...
vc_map( array(
	"base" => "trx_rocks_item",
	"name" => __("Rock Item", "themerex"),
	"description" => __("Rock item", "themerex"),
	"show_settings_on_create" => true,
	'icon' => 'icon_trx_rocks_item',
...
vc_map( array(
	...
	"name" => __("Round item", "themerex"),
	"show_settings_on_create" => true,
	'icon' => 'icon_trx_around_item',
...
vc_map( array(
	"base" => "trx_points",
	"name" => __("Points (blocks with arrows)", "themerex"),
